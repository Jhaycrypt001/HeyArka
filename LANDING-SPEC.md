...
| Canary agreement rate | `46 of 46` over 69.0h, 23 real Demo orders per account (BTCUSDT); ETHUSDT runs separately in `reports/canary-eth.jsonl` | `node scripts/canary-figures.mjs` |
...
is the **agreement rate**, not profit. 46 of 46 agreement over 69.0 hours is a
